...
begin	
	...
	fформат = trim(to_char(fтекущее, '999 999 999 999 999 999 999 999 999'));
...
\echo
\echo Пример вызова функции с распечаткой всех значений:
\echo
select фибоначчи(32, true) "Число Фибоначчи для N = 32";

\echo
\echo Пример вызова функции без вывода всех значений:
\echo
